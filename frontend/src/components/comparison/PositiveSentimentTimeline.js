...
const PositiveSentimentTimeline = ({ timelineData, selectedProductIds, isLoading, error }) => {
  ...
  // Process timeline data for positive sentiment
  const processTimelineData = (timelineData, productId) => {
    ...
    console.log(`Final positive timeline data for ${productId}:`, result.slice(0, 3));
    return result;
  };
  ...
  if (isLoading) {
    return (
      <div className="bg-gray-200 border border-gray-400 rounded-xl p-6 shadow-lg">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">Positive Sentiment Timeline</h3>
  ...
  // Create chart data
  const monthlyPositiveChartData = createMultiProductMonthlyPositiveChart(timelineData, selectedProductIds);
  ...
  return (
    <div className="bg-gray-200 border border-gray-400 rounded-xl p-6 shadow-lg">
      <h3 className="text-lg font-semibold text-gray-800 mb-2">Positive Sentiment Timeline</h3>
...
export default PositiveSentimentTimeline;
