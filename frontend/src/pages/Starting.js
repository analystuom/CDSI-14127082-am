    ...
    <div className="pl-6 pr-8 py-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Welcome to Pulsar Analytics
        </h1>
        
        <p className="text-gray-600 text-lg leading-relaxed">
          We help you conduct sentiment analysis and derive insights from customer reviews with designated tabs of different sentiment visualizations.
        </p>
      </div>
